...
class Gpt2(PreTrainedModel):
    def __init__(self, config, gpt2):
        ...
        self.ctokneizer = AutoTokenizer.from_pretrained(cgpt2_model, local_files_only=True)
        self.ctokneizer.pad_token = self.ctokneizer.eos_token
        self.cgpt2 = AutoModel.from_pretrained(cgpt2_model, local_files_only=True)
    ...
    def create_nl_embd(self, input_ids, attention_mask):
        return self.ngpt2(input_ids, attention_mask)

    def create_pl_embd(self, input_ids, attention_mask):
        return self.cgpt2(input_ids, attention_mask)
